...
vars = {
  ...
  'skia_revision': 'bbc5288f2bb1a7951bbacedb9ab3d131147edb89',

  # BD ADD: START
  'tt_dart_git': 'ssh://git@code.byted.org/tech_client/dart',
  # 'tt_dart_revision': '946021afdb1b19a67a953f4d369cb58c2604736a',
  'tt_dart_revision': '11be2812973fc890f2f46f77180668372eb1df4d',
  'tt_skia_git': 'git@code.byted.org:tech_client/skia.git',
  'tt_skia_revision': 'c9222a0dfe2a7011b74ce5b05f2e94e86ad9df13',
  ...
  'dart_revision': 'f565c36f18e342368e97bf9b8830525c91d07237',
  ...
  'dart_pub_rev': 'fd836c0ea8ce2aebdcbfd67cce0ac7a7f093a524',
...
deps = {
  ...
  'src': 'ssh://git@code.byted.org/tech_client/buildroot' + '@' + 'f52aee6dd64420adbf205cea6400b72fffbd2ad7',
  ...
  'src/third_party/dart/third_party/pkg/html':
   Var('dart_git') + '/html.git@7f31979303f916f2aabb9e2091950798abdd9ca1',
  ...
  'https://skia.googlesource.com' + '/external/github.com/google/wuffs.git' + '@' +  'c86add25f790360f0aca026c4f1c2c4e2d12408d',
    ...
    'packages': [
      {
        ...
        'version': '139p8dSfWkDS3XU7olg1SCcPowC4MokiYUR5u2aqDOMC' 
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'PGWwkVe7csXAv7k2KVF3U_W6uYr_lVOMjOFcwPQj5x8C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'DLfskqEUxYkkh1CQFJcig1VvspwNdhmMhHN_I5oAr2UC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
