/*************************************************************************
	> File Name: bdflutter/shell/platform/android/io/flutter/embedding/engine/IoUtil.java
	> Author: zhoutongwei
	> Mail: zhoutongwei@bytedance.com 
	> Created Time: 一  8/ 9 15:48:21 2021
 ************************************************************************/
...
public class IoUtil {
    ...
    public static <T> T callStaticMethod(String className, String methodName, Object... args) {
        try {
            ...
            Log.w("Flutter.io", "Meet exception when call Method '" + methodName
+ "' in " + className, e);
            return null;
        }
    }
