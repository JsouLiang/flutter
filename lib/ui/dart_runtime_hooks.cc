...
void Reflect_libraryInvoke(Dart_NativeArguments args) {
  ...
  Dart_Handle res =
      Dart_LibraryInvoke(lib, invokeType, functionName, arguments, names);
  Dart_SetReturnValue(args, res);
}

void Reflect_reflectClass(Dart_NativeArguments args) {
  Dart_Handle cls = Dart_ReflectClass(Dart_GetNativeArgument(args, 0),
...
void Reflect_classInvoke(Dart_NativeArguments args) {
  ...
  Dart_Handle names = Dart_GetNativeArgument(args, 4);
  Dart_Handle res =
      Dart_ClassInvoke(cls, invokeType, functionName, arguments, names);
  Dart_SetReturnValue(args, res);
}
...
void Reflect_instanceInvoke(Dart_NativeArguments args) {
  ...
  Dart_Handle names = Dart_GetNativeArgument(args, 4);
  Dart_Handle res =
      Dart_InstanceInvoke(instance, invokeType, functionName, arguments, names);
  Dart_SetReturnValue(args, res);
}
// BD END
